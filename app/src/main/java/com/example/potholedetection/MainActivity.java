...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    String url = "http://10.248.2.223:5000/predict";
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD) {
            ...
            xValue.setText("mag xValue: " + sensorEvent.values[0]);
            yValue.setText("mag yValue: " + sensorEvent.values[1]);
            zValue.setText("mag zValue: " + sensorEvent.values[2]);
        ...
        if (sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            accxValue.setText("acc xValue: " + sensorEvent.values[0]);
            accyValue.setText("acc yValue: " + sensorEvent.values[1]);
            acczValue.setText("acc zValue: " + sensorEvent.values[2]);
        ...
        if (sensor.getType() == Sensor.TYPE_GYROSCOPE) {
            ...
            gyroxValue.setText("gyro xValue: " + sensorEvent.values[0]);
            gyroyValue.setText("gyro yValue: " + sensorEvent.values[1]);
            gyrozValue.setText("gyro zValue: " + sensorEvent.values[2]);
    ...
    public void CallApi(){
        ...
        try {
            postData.put("acc_x",accx);
            postData.put("acc_y",accy);
            postData.put("acc_z",accz);
            postData.put("gyro_x",gyrox);
            postData.put("gyro_y",gyroy);
            postData.put("gyro_z",gyroz);
            postData.put("mag_x",magx);
            postData.put("mag_y",magy);
            postData.put("mag_z",magz);
